...
**正式版本** -  [下載 Rebocap V01](https://doc.rebocap.com/img/files/rebocap_release_v01.exe)


**Beta版本** - [下載 Rebocap V02 Beta02](https://doc.rebocap.com/img/files/rebocap_release_v02_beta02.exe)
...
<details>
<summary> 查看軟體對應支援的韌體版本和操作說明。</summary>
...
<div style="flex: 1.5; min-width: 250px;">
<strong>1 - 沒有大臂追蹤器時，手動關閉額外顯示的追蹤點。</strong><br />
