...
2. 최소 8개의 트래킹 포인트를 착용한 후 액션 캘리브레이션을 클릭합니다. Apose 캘리브레이션 중에 헤드셋을 올바르게 착용해야 합니다 [특히 빠른 신호음이 울릴 때]. 구체적인 [캘리브레이션 (Calibration) 절차는 여기를 참조하세요](../../tutorial/connect_and_use#pose_calibration)
