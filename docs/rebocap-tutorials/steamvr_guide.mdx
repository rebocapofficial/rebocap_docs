...
#slide1:checked ~ .html-carousel-controls label[for="slide1"],
#slide2:checked ~ .html-carousel-controls label[for="slide2"],
#slide3:checked ~ .html-carousel-controls label[for="slide3"] {
  background: #fff;
  transform: scale(1.2);
}
</style>
